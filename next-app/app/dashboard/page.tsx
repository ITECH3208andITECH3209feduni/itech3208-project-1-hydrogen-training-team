...
export default function Dashboard() {
    ...
    useEffect(() => {
        async function loadQuizProgress() {
            try {
                ...
                console.error("Failed to load dashboard quiz progress:", error);
                setQuizProgress(null);
            } finally {
    ...
    const completedModules = useMemo(() =>
        modules.filter((module) =>
            module.status === "done" || Number(module.progress) >= 100
        ).length, [modules]
    );

    const inProgressModules = useMemo(() =>
        modules.filter((module) => 
            Number(module.progress) > 0 && Number(module.progress) < 100
        ).length, [modules]
    );

    // Certificate eligibility
    const allModulesCompleted = totalModules > 0 && completedModules === totalModules;
    const certificateEligible = allModulesCompleted && !!quizProgress && quizProgress.score >= 70;
        ...
        <main className="main">
                ...
                <section className="dashboard-panel certificate-panel">
                    ...
                    <div className="certificate-content">
                        ...
                        <div className="certificate-text">
                            ...
                            {certificateEligible ? (
                                <p>Congratulations! You have completed all required training modules and passed the final quiz.</p>
                            ) : (
                                <p>Complete all required training modules and pass the final quiz with a score of 70% or higher to unlock your certificate.</p>
                            )}
                        </div>
            ...
            <section className="feedback-panel">
                ...
                <div className="feedback-info">
                    <h2>Feedback</h2>
                    <p>Help us improve the Hydrogen Lab Safety training experience by sharing your feedback.</p>
                </div>
