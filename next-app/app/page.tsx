	...
	return (
		...
		<main className="main">
			...
			<div className="greeting">
				...
				<p>
					Continue your hydrogen technology training journey
				</p>
						...
						<div className="module-list">
							...
							<div className="module-item">
								...
								<div className="module-name">
									H₂ Fundamentals &amp; Properties
								</div>

								<div className="module-status status-done">
									Done
								</div>
							...
							<div className="module-item">
								...
								<div className="module-status status-prog">
									In Progress
								</div>
							...
							<div className="module-item">
								...
								<div className="module-status status-todo">
									Not Started
								</div>
