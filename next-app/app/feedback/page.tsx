        ...
        return (
            <main className="feedback-page">
                <section className="feedback-card feedback-success">
                    ...
                    <h1>Thank You!</h1>
                    <p>Your feedback has been received. Thank you for helping us improve the Hydrogen Lab Safety training experience.</p>
    ...
    return (
        <main className="feedback-page">
            <div className="feedback-heading">
                ...
                <h1>Feedback</h1>
                <p>Help us improve the Hydrogen Lab Safety training experience.</p>
            </div>
